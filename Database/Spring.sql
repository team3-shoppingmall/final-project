...
insert into reviewtable(productno, content, id, image, star) values(1,'<p>이전에 다른 색상으로 구매했었는데 재질도 좋고 착용감도 좋아서 새로 또 구매했어요!&nbsp;</p><p>그레이 색상이라 전체적으로 색감이 다운됐지만, 그 만의 매력이 있어서 마음에 들어요!</p>','tester2', 'image1.jpg','4');
insert into reviewtable(productno, content, id, image, star) values(2,'<p>가을에 휘뚜루마뚜루 입으려고 샀어요 검정+보라 스트라이프 사고 싶었는데 라벤더네이비도 충분히 예쁘네요&nbsp;</p><p>너무 오버핏도 아니고 너무 베이직한 핏도 아니라서 딱 맘에 들어요 다른 색으로 더 살 것 같아요 쌩유</p>','tester2', 'image2.jpg','4');
...
insert into reviewtable(productno, content, id, image, star) values(1,'<p>개인적으로 색깔은 솔직히 실망했어요. 예쁜 베이지가 아니라 그냥 황토색? 상세샷보다도 좀 어두워요.</p><p>다른 분들 후기처럼 냄새는 많이 나고 꺼끌거려요. 그리고 무엇보다 털이 진짜.. 어마무시하게 빠집니다.&nbsp;</p><p>안에 검정색 히트텍 입었다가 깜짝 놀랐어요..</p>','tester1', 'image1.jpg','1');
insert into reviewtable(productno, content, id, image, star) values(2,'<p>너무 이뻐요 사길 후회 안할정도로 ...팔뚝잇는66인데 이거 입고 55로 보인데요..(엄마 눈에만)&nbsp;</p><p>배송은 좀 느리게 왓더라고요! 제가 사진후기 잘 안올리는데 품절 풀리면 바로사세오...</p>','tester2', 'image2.jpg','4');
insert into reviewtable(productno, content, id, image, star) values(1,'<p>바스락거리는 소재에요! 약간 단작셔츠같은 느낌..! 제가 좋아하는 느낌이에요 히히&nbsp;</p><p>근데 159인 제 키에는 뒷쪽 언발 부분이 엉덩이를 다 가리고도 살짝 더 내려와서&nbsp;</p><p>안그래도 작은 키가 더 작아보이긴 하네요,, 그래도 색감이나 핏 다 너무 예쁘고&nbsp;</p><p>소매쪽 핀턱때문에 포인트도 되고! 마음에 들어요 ´ㅅ`</p>','tester3', 'image1.jpg','3');
insert into reviewtable(productno, content, id, image, star) values(2,'<p>편하게 입으려고 샀는데, 후기를 미처 꼼꼼히 못 읽은 것 같아요. 피부 좀 예민하신 분들은 엄청 따갑습니다.&nbsp;</p><p>특히 가운데 지퍼 부분이 까끌해서 피부 엄청 빨갛게 돼요ㅠ 그리고 털이 너무 많이 빠져서 코트에 다 묻습니다.&nbsp;</p><p>예쁘지만 산 것 중에 유일하게 좀 실망한 니트예요ㅠㅠ</p>','tester4', 'image2.jpg','2');
insert into reviewtable(productno, content, id, image, star) values(1,'<p>이옷은 제가 산것중 제일 실망입니다,,물론 디자인은 나쁘진 않은데 원단이 좀,,싼티나요 보풀도 많이나고,,</p><p>진짜 믿고 구매하는데 오래기다려서 받았는데 반품이 귀찮아입어요;;</p>','tester5', 'image1.jpg','1');
insert into reviewtable(productno, content, id, image, star) values(1,'<p>인기가 워낙 많았던 제품이라서 오래 기다려서 받았어요!엄마도 이때까지 산 셔츠중에 이게 가장 예쁘다고 하시네요 ㅎㅎ&nbsp;</p><p>언발 기장으로 떨어지는 게 너무 예쁩니당 얼른 날 풀려서 단독으로 입고 다니고 싶어요ㅠㅠ</p>','tester1', 'image1.jpg','5');
insert into reviewtable(productno, content, id, image, star) values(2,'<p>색이 정말 이뻐요! 색상은 화면과 같아요! 다만 구김 옴청 잘 가는 소재 ㅠ&nbsp;</p><p>알고 샀지만 생각보다 더 바스락 거리는 구김 가는 소재에요 ㅎㅎ</p><p>입을때마다 열심히 다리미해야겠어요!</p>','tester2', 'image2.jpg','4');
insert into reviewtable(productno, content, id, image, star) values(1,'<p>거울이 너무 더럽지만 리뷰 써봐용 ㅠㅠ&nbsp;</p><p>교복 같을까봐 걱정했는데 블랙이라 그런 느낌도 덜 해서 다행이고&nbsp;</p><p>길이도 너무 짧지 않고 적당해서 자주 입을 것 같아요</p>','tester3', 'image1.jpg','4');
insert into reviewtable(productno, content, id, image, star) values(2,'<p>바스락바스락 얇은 옷이에요. 근데 무엇보다.. 색감이 미쳤어요ㅠㅠㅠㅠ 진짜 너무 예쁩니다.&nbsp;</p><p>유치하고 가벼운 느낌 아니고 차분해요. 핏은 오버핏인데 언발란스한 기장 덕분에 남의 옷 입은 느낌 1도 없고 여리여리해보여요.&nbsp;</p><p>빨리 따뜻해져서 단독으로 입고싶은 옷이에요.ㅠㅠㅠ</p>','tester4', 'image2.jpg','4');
insert into reviewtable(productno, content, id, image, star) values(1,'<p>첨에 입을 땐 스판이 아예 없어서 놀랐는데 그만큼 세탁만 잘 하면 오래 입을 수 있을 것 같아 마음에 들어욤 ㅎ-ㅎ&nbsp;</p><p>길이감도 적당합니당 제작 아닌 상품 오랜만에 구매해보는데 만족해요!&nbsp;</p>','tester', 'image1.jpg','4');
insert into reviewtable(productno, content, id, image, star) values(1,'<p>이번에 산 옷들끼리 코디해봤는데 이 스커트 인스타로 봤을 때 부터 이건 사야한다 싶었는데 진짜 너무 이쁘네요ㅜㅜ</p><p>이번 할인구매 물품 중에 1등입니다ㅜㅜ저는 사실 쬐끔만 더 짧았으면 햇는데 딱 안정적으로 이쁜 길이긴 해요ㅎㅎ</p>','tester5', 'image1.jpg','4');
insert into reviewtable(productno, content, id, image, star) values(2,'<p>요즘 옷들이 작아서 안 맞을까 걱정했는데(ㅠㅠ)&nbsp;</p><p>불편하지 않게 딱 맞아요! 핏도 맘에 들고 만족스러워용^.^</p>','tester5', 'image2.jpg','5');
insert into reviewtable(productno, content, id, image, star) values(1,'<p>딱 봄 가을에 입기 좋을 얇은 두께입니다 겨울에는 너무 추울 것 같아요&nbsp;</p><p>에스 사이즈로 샀는데 조금 크게 나온 것 같아요</p><p>그래서인지 핏하게 예쁘게 떨어지지는 않아 조금 아쉽습니다 ㅠㅠ</p>','tester5', 'image1.jpg','4');
-- 문의
